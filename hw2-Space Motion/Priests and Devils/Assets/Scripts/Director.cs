...
public class PriestManager
{
    ...
    {
        return moveScript.GetObjectStatus();
    }
...
public class BoatManager
{
    ...
    public BoatManager()
    {
        boat = UnityEngine.Object.Instantiate(Resources.Load("Prefabs/boat", typeof(GameObject)), new Vector3(1.8f, 0.15f, -4), Quaternion.identity, null) as GameObject;
    ...
    public void MoveBoat()
    {
        ...
        if (priest1 != null)
        {
            ...
            priest1.SetPriestDestination(des);
        }
        if (priest2 != null)
        {
            ...
            priest2.SetPriestDestination(des);
        }
        if (devil1 != null)
        {
            ...
            devil1.SetDevilDestination(des);
        }
        if (devil2 != null)
        {
            ...
            devil2.SetDevilDestination(des);
        }
    }
...
public class CoastManager
{
    ...
    public CoastManager()
    {
        coastRight = UnityEngine.Object.Instantiate(Resources.Load("Prefabs/coast", typeof(GameObject)), new Vector3(4.4f, 0, -4), Quaternion.identity, null) as GameObject;
        coastLeft = UnityEngine.Object.Instantiate(Resources.Load("Prefabs/coast", typeof(GameObject)), new Vector3(-4.4f, 0, -4), Quaternion.identity, null) as GameObject;
        for(int i = 0; i < 3; i++)
        {
